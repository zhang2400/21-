...
void check_garage() {
    ...
    //     }
        ...
        for (int i = 10; i < MIN(80, garage_rpts_num); i++) {
            ...
            ptr = img_bin.ptr(pt[1]);
            int zebra_cross_flag_begin = ptr[pt[0]] > 125;
            ...
            for (int x = pt[0] - 1; x >= MAX(0, pt[0] - 50); x--) {
                ...
                if (zebra_cross_flag_begin == 0) { // even white, odd black
                    if (zebra_cross_flag0_num % 2 == 0 && ptr[x] > 125) { // current even, current white
                        zebra_cross_flag0[zebra_cross_flag0_num]++;
                    } else if (zebra_cross_flag0_num % 2 == 0 && ptr[x] < 125) { // current even, current black
                        zebra_cross_flag0[++zebra_cross_flag0_num]++;
                    } else if (zebra_cross_flag0_num % 2 == 1 && ptr[x] > 125) { // current odd, current white
                        zebra_cross_flag0[++zebra_cross_flag0_num]++;
                    } else if (zebra_cross_flag0_num % 2 == 1 && ptr[x] < 125) { // current odd, current black
                        zebra_cross_flag0[zebra_cross_flag0_num]++;
                    }
            ...
            for (int x = pt[0] + 1; x <= MIN(img_bin.cols - 1, pt[0] + 50); x++) {
                if (zebra_cross_flag_begin == 0) { // even white, odd black
                    if (zebra_cross_flag1_num % 2 == 0 && ptr[x] > 125) { // current even, current white
                        zebra_cross_flag1[zebra_cross_flag1_num]++;
                    } else if (zebra_cross_flag1_num % 2 == 0 && ptr[x] < 125) { // current even, current black
                        zebra_cross_flag1[++zebra_cross_flag1_num]++;
                    } else if (zebra_cross_flag1_num % 2 == 1 && ptr[x] > 125) { // current odd, current white
                        zebra_cross_flag1[++zebra_cross_flag1_num]++;
                    } else if (zebra_cross_flag1_num % 2 == 1 && ptr[x] < 125) { // current odd, current black
                        zebra_cross_flag1[zebra_cross_flag1_num]++;
                    }
                } else { // even black, odd white
                    if (zebra_cross_flag1_num % 2 == 0 && ptr[x] > 125) { // current even, current white
